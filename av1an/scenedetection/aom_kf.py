...
def aom_keyframes(
    ...
    f, e = compose_aomsplit_first_pass_command(
        video_path, stat_file, ffmpeg_pipe, video_params, is_vs
    )
    ...
    pipe = subprocess.Popen(
        e, stdin=ffmpeg_pipe.stdout, stdout=PIPE, stderr=STDOUT, universal_newlines=True
    )
