...
class Args:
    ...
    def get_difference(self) -> dict:
        ...
        """
        return dict(
            [x for x in self.parsed.items() if x not in self.defaults.items()])
